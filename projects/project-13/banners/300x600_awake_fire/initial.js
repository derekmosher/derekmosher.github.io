...
/******************** VARIABLES  ********************/ 
	...
	function politeInit(){	
       ...
       devDynamicContent.WLV_awakening_v2b_main[0].color_ctaBG = "#ec1d00";
       devDynamicContent.WLV_awakening_v2b_main[0].color_ctaBG_over = "#ff0000";
...
//DRM_Asset:Wynn Las Vegas/WLV_awakening_v2b/300x600/blank.png
...
/******************  MAIN ANIMATION  ******************/ 
		function animate() { 
            ...
            let price_blank = dcSize.pic_price.Url.includes("blank");
            let version_air = dcSize.pic_front.Url.includes("air");
            if(price_blank){
                cta.style.top = "563px"
                titleWrap.style.top = "493px"
                if(!version_air) imageDivs[3].style.top="60px"; //quote
                imageDivs[2].style.visibility="hidden";
            }
